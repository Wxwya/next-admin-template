...
import XwyaGoodsDialog from '@/components/XwyaGoodsDialog'
...
const GoodsList = () => {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex gap-2 cursor-pointer">
             <XwyaGoodsDialog title='編輯貨物' id={payment.id}>
              <span>修改</span>
              </XwyaGoodsDialog>
  ...
  return (
    <Layout link='貨物管理' href='/goodsType'  page='貨物列表' pathKey='/goodsList'>
